...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/ceres-solver-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ceres-solver-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add ceres-solver
# for installing globally
pixi global install ceres-solver
```
...
It is possible to list all of the versions of `ceres-solver` available on your platform:
